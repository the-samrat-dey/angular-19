...
{ "_.{js,jsx,ts,tsx}": ["npx pretty-quick --staged", "npm run lint:fix"],
"_.html": ["npx pretty-quick --staged", "npm run lint:fix"],
"_.{css,scss,sass,less}": [ "npx pretty-quick --staged", "stylelint --fix",
"stylelint --max-warnings 0 || exit 1" ], "_.{json,md,yml,yaml}": ["npx
pretty-quick --staged"] }
